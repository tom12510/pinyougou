                        ...
                        <div id="specification" class="summary-wrap clearfix">
                            <#list specificationList as s>
                                <dl>
                                    ...
                                    <#list s.attributeValue as av>
                                    <dd>
                                        <!-- class="selected" -->
                                        <a href="javascript:;"
                                           :class="isSelectedSpec('${s.attributeName}', '${av}') ? 'selected' : ''"
                                           @click="selectSpec('${s.attributeName}', '${av}')">${av}
                        ...
                        <div class="summary-wrap">
                            <div class="fl title">
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="text" v-model="num" class="itxt"/>
            ...
            <div class="clearfix product-detail">
                ...
                <div class="fr detail">
                    ...
                    <div class="tab-main intro">
                        ...
                        <#--扩展属性列表
                            [{"text":"分辨率","value":"1920*1080(FHD)"},
                             {"text":"摄像头","value":"1200万像素"}]
                        -->
