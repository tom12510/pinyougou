...
window.onload = function () {
    ...
    var vue = new Vue({
        ...
        data : { // 数据模型
            ...
            entity : {specificationOptions : []}, // 数据封装对象(表单)
            page : 1, // 当前页码
            pages : 0, // 总页数
        ...
        methods : { // 定义操作方法
            ...
            show : function(entity){ // 数据回显
                axios.get("/specification/findSpecOption?id="
                    + entity.id).then(function(response){
                    // 规格选项数组
                    entity.specificationOptions = response.data;
                    // 把entity对象转化成json字符串
            ...
            deleteTableRow : function (idx) {
                // 第一个参数：元素在数组中的索引号
                // 第二个参数：删除的个数
                this.entity.specificationOptions.splice(idx,1);
            }
        },
